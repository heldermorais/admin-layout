...
<html>
    ...
    <body>
        ...
        <div id="show-notification" class="content scaffold-show" role="main">
            ...
            <f:display bean="notification" />
            <g:form resource="${this.notification}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.notification}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
